  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-warning elevation-2">
      ...
      <a href="/" class="brand-link">
        ...
        <span class="brand-text font-weight-light">RoyalBrains</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a :href="route('dashboard')" class="d-block">{{ $page.props.user.name }}</a>
          </div>
        </div>
    ...
    <footer class="main-footer">
      <div class="float-right d-none d-sm-block">
        <b><a href="https://jetstream.laravel.com">Royalbrainsms</a></b>
      </div>
      <strong>Powered by</strong> <a href="https://adminlte.io">Royalbrains Technology</a>
    </footer>
  </div>
</template>
